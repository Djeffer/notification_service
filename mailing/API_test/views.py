...
class TestStat(APITestCase):
    def test_mailing(self):
        ...
        mail_create = {"date_start": now(), "date_end": now(), 'time_start': now().time(), 'time_end': now().time(),
                       "text": "Simple text", "tag": "new", "mobile_operator_code": '123'}
    ...
    def test_client(self):
        ...
        client_create = {"phone_number": '79999999999', "tag": "new", "timezone": "UTC"}
